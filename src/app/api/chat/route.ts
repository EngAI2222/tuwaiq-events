  ...
  try {
    ...
    if (!apiKey || apiKey === "your_api_key_here") {
      ...
      return NextResponse.json({
        response: "عذراً، أواجه مشكلة في الاتصال حالياً. لكن يسعدني إخبارك أننا في لمسة إيفنس نقدم أفضل خدمات تنظيم المناسبات في الرياض! كيف يمكنني مساعدتك بشكل عام؟"
      });
    }
    ...
    const prompt = `
      أنت مساعد ذكي فاخر لشركة "لمسة إيفنس للمناسبات الفاخرة" في الرياض.
      مهمتك هي الرد على استفسارات العملاء بأسلوب راقٍ ومختصر ومهني جداً.
      خدمات لمسة إيفنس تشمل: كوش الأفراح، طاولات العشاء، ضيافة VIP، إضاءة وصوتيات، وتنسيق شامل للمكان.
